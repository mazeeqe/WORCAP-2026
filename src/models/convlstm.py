...
class ConvLSTMForecaster(nn.Module):
    ...
    def forward(
        ...
        """Retorna precipitação não negativa com shape `(batch, lat, lon)`.

        `target_month_features` contém o estado observado em M que acompanha o
        alvo M+1 no arquivo de teste; o nome é mantido por compatibilidade.
        """
